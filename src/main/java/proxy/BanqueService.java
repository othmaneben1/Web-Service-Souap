...
public interface BanqueService {
    ...
    @RequestWrapper(localName = "conversationEuroToDH", targetNamespace = "http://ws/", className = "proxy.ConversationEuroToDH")
    @ResponseWrapper(localName = "conversationEuroToDHResponse", targetNamespace = "http://ws/", className = "proxy.ConversationEuroToDHResponse")
    @Action(input = "http://ws/BanqueService/conversationEuroToDHRequest", output = "http://ws/BanqueService/conversationEuroToDHResponse")
    public double conversationEuroToDH(
